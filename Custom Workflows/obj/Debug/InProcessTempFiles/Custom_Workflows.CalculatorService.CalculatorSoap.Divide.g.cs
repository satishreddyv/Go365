...
namespace Custom_Workflows.CalculatorService.Activities {
    ...
    public partial class Divide : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        private System.Activities.OutArgument<int> _DivideResult;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.OutArgument<int> DivideResult {
            get {
                return this._DivideResult;
            }
            set {
        ...
        private string FindResource() {
            string[] resources = typeof(Divide).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Custom_Workflows.CalculatorService.CalculatorSoap.Divide.g.xaml") || resource.Equals("Custom_Workflows.CalculatorService.CalculatorSoap.Divide.g.xaml"))) {
                    return resource;
                }
            }
